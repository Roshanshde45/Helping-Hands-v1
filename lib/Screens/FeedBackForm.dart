...
class _FeedBackFormState extends State<FeedBackForm> {
  ...
  Future<void> saveFeedBack() async {
    ...
    try {
      databaseReference.child("Feedbacks").update({
        timeStamp: {
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "How can we improve the Helping Hands app?",
                        style:
                            TextStyle(color: CustomColor.red, fontSize: 50.sp),
                      ),
                      SizedBox(
                        height: 55.h,
                      ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: FlatButton(
                          ...
                          child: Text("Submit",style: TextStyle(color: Colors.white,fontSize: 48.sp),)),color: CustomColor.red,
